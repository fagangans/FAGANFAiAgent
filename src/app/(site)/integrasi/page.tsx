...
const CHANNEL_VISUALS = [
  ...
  { Logo: LinkIcon, color: "text-emerald-600" },
  { Logo: ChartIcon, color: "text-teal-600" },
];
            ...
            return (
              <Reveal key={channel.name} delay={idx * 80}>
                <div className="group rounded-2xl border border-slate-100 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-emerald-200 hover:shadow-lg">
                  <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-emerald-50 transition duration-300 group-hover:scale-110">
