    ...
    <>
      ...
      <section className="overflow-hidden bg-gradient-to-b from-emerald-50 to-white">
        <div className="mx-auto max-w-5xl px-6 py-20 text-center">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              href="/kontak"
              className="rounded-full bg-emerald-500 px-7 py-3 text-base font-semibold text-white shadow-md transition hover:bg-emerald-600"
            >
              {hero.ctaPrimary}
            </Link>
            <Link
              href="/fitur"
              className="rounded-full border border-slate-200 bg-white px-7 py-3 text-base font-semibold text-slate-700 transition hover:border-emerald-300 hover:text-emerald-600"
            >
              {hero.ctaSecondary}
            </Link>
          </div>
      ...
      <section className="bg-emerald-500 py-16">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <Link
            href="/kontak"
            className="mt-8 inline-block rounded-full bg-white px-7 py-3 text-base font-semibold text-emerald-600 shadow-md transition hover:bg-emerald-50"
          >
            {ctaBanner.ctaLabel}
          </Link>
        </div>
